...
Use `Change Summary Handoff` when file editing is requested. It must be concise enough to pass into `sp-deck` and should include the expected improved PPTX filename plus `outputs/<topic>-change-summary.md`.
